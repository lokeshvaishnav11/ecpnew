...
function displayHistoryPage(historyData) {
    ...
    historyData.forEach(bet => {
        ...
        row.innerHTML = `
            ...
            <!-- <td style="border: 1px solid #4b5563; padding: 6px 8px; text-align: center;">${bet.created_at ? new Date(bet.created_at).toLocaleString('en-IN', { timeZone: 'Asia/Kolkata' }) : 'N/A'}</td> -->
        `;
    });
}
